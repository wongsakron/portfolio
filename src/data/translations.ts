      ...
      jobs: [
        ...
        },
        {
          ...
          bullets: [
            ...
            "Developed an end-to-end Internal AI Assistant using n8n workflows and RAG architecture, utilizing pgvector and a local LLM (Ollama).",
          ],
        },
      ],
    },
      ...
      jobs: [
        ...
        },
        {
          ...
          bullets: [
            ...
            "พัฒนาระบบ Internal AI Assistant (End-to-End) ด้วย n8n และ RAG โดยใช้ pgvector และโมเดลภาษา LLM (Ollama)",
          ],
        },
      ],
    },
